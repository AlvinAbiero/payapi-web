...
const Hero = () => {
  return (
    <div className='flex flex-col-reverse px-8 pb-16 items-center  max-w-176 lg:min-w-full mx-auto  lg:grid lg:grid-cols-2 lg:justify-items-center relative -top-20'>
       {/* CTA */}
       <div className='text-center lg:text-left px-8 lg:mt-0 -mt-48'>
        ...
        {/* contact us */}
         ...
         {/* phone mockup */}
        <Image src={phoneMockup} alt="phone mockup" className=' lg:scale-[1] md:scale-[0.8] scale-65 lg:mt-0 lg:ml-0 -mt-24 ml-10'/>
    </div>
  )
}
